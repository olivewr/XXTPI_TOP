...
AND hl_bill.location_id       =hps_bill.location_id
     ...
     -- and     rat.BILL_TO_CUSTOMER_ID = cust.CUSTOMER_ID
      ...
      and    gld.org_id in (103, 162, 164, 166, 168, 170, 183, 184, 282, 342, 382, 383, 422,442, 481, 542, 562, 582, 585, 622, 624, 625, 668, 690, 709, 728, 748, 768, 848, 808)
     -- and    gld.org_id in ('768')
